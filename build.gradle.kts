...
// Project properties
group = "github.kasuminova.lumenized"
version = "1.0.3"
...
tasks.jar.configure {
    manifest {
        ...
        attributes["FMLCorePlugin"] = "github.kasuminova.lumenized.mixin.LumenizedEarlyMixinLoader"
        attributes["FMLCorePluginContainsFMLMod"] = true
        attributes["FMLAT"] = "lumenized_at.cfg"
    }
}
...
//    implementation("zone.rong:mixinbooter:7.1")
    val mixin : String = modUtils.enableMixins("zone.rong:mixinbooter:8.9", "mixins.lumenized.refmap.json").toString()
    api (mixin) {
        isTransitive = false
    }
    ...
    implementation(rfg.deobf("curse.maven:ae2-extended-life-570458:5147702")) // For testing
    implementation(rfg.deobf("curse.maven:chisel-235279:2915375")) // For testing
    implementation(rfg.deobf("curse.maven:ctm-267602:2915363")) // Required
    compileOnly(rfg.deobf("curse.maven:modular-routers-250294:2954953")) // Bug Fixes
}
